...
<!-- Path: src\lib\containers\Navbar.svelte -->
<!-- Navbar for enigma -->

<div class="navbar flex p-2 sticky top-0 z-10 shadow-lg bg-gradient-to-r from-base-100 to-base-300">
  ...
  <div class="navbar-center hidden lg:flex">
    <ul class="menu menu-horizontal px-1">
      <li><a class="btn btn-ghost">Vault</a></li>
      <li><a class="btn btn-ghost">Send</a></li>
    </ul>
  </div>

...
<div class="min-h-screen py-6 bg-gradient-to-b from-slate-800 to-base-200">
  {#if isLoading}
    <LoadingSpinner />
  {:else}
    <form
    ...
    >
      ...
      <div
        class="flex flex-col items-center justify-center gap-4 w-full max-w-md mt-10"
      >
